      ...
      <div>
        <footer className="page-footer blue-grey darken-4 footer-div">
          <div className="footer-copyright">
            ...
            <Link className="grey-text text-lighten-4 right space" to="/about" target="_blank">About Us</Link>
            <Link className="grey-text text-lighten-4 right space" to="/" target="_blank">Home</Link>
